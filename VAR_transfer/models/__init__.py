...
def build_vae_var(
    ...
    flash_if_available=True, fused_if_available=False,
    ...
    # 传递args给模块
    from models import basic_var, var
    basic_var.args = args
    var.args = args
    ...
    var_wo_ddp = VAR(
        vae_local=vae_local,
        num_classes=num_classes, depth=depth, embed_dim=width, num_heads=depth, drop_rate=0., attn_drop_rate=0., drop_path_rate=dpr,
