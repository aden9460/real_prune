...
sparsity=0.2
num_samples=150
prune_method="new_average_slimgpt_1epoch_cfgoriginal-4_test4"
output_name="real_d${depth}_${sparsity}sparsity_${num_samples}i_${prune_method}_method"
var_model="/home/waas/real_prune/VAR_train/0.2_d16_real_1epoch_new_average_slimgpt_150i/ar-ckpt-last.pth"
