...
torchrun --nproc_per_node=8 --nnodes=1 --node_rank=1 --master_addr=12345 --master_port=1 train.py \
  --depth=16 --bs=768 --ep=20 --fp16=1 --alng=1e-3 --wpe=0.1 --local_out_dir_path /home/waas/daily/AR/VAR_real/train_result/d16_bilinear
